...
"poolServer": {
    ...
    "poolAddress": "Lok7BGB3Tr1Ma7sZjRYziWMfSUiuHgtwEE8yEyGSDAYmDKs94TTuPyJNcuC9NHtz9uH9b19R3HV6PTCzCb9W8uCnArbGx5X",
...
"payments": {
    ...
    "maxAddresses": 30, //split up payments if sending to more than this many addresses
    ...
    "maxTransactionAmount": 30000000000, //split transactions by this amount(to prevent "too big transaction" error)
...
"blockUnlocker": {
    ...
    "depth": 60,
    "poolFee": 0.1, //0.1% pool fee (2% total fee total including donations)
...
"api": {
    ...
    "updateInterval": 10, //gather stats and broadcast every this many seconds
    "port": 8117,
